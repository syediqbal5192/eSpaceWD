jQuery(document).ready(function () {
	...
	$("#readinessTemplateReportGrid").jqGrid({
	    ...
	    postData: {
		 ...
		 colNames:['Company Name','Company Name','Readiness Name','Owner Name','Element Status','ReadinessQuantity','Start Date','End Date'],
		    colModel: [ 
		                {
		    	name:'companyName',
		    	index:'companyName',
	...
	function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
	    ...
	    var fileName = "Readiness_State_Report_";
	...
	$('#excelReadinessPort').click(function() {
	    console.log('test');
	   JSONToCSVConvertor(JSON.stringify($('#readinessTemplateReportGrid').jqGrid('getRowData')), 'Title', true);
	});
