...
jQuery("#grid").jqGrid({
    ...
    colNames:['Id','Warehouse Name','Floor Built-up Area', 'Floor Carpet Area' , 'Rack Built-up Area','Rack Carpet Area','Total Docks','Edit','Delete'],
    colModel:[
...
/*function deleteRecordWH(warehouseId){*/
    ...
    for (var i = 0; i < value1.length; i++) 
    {
        ...
        /*	 noty({
                 text: 'Warehouse in use.Please verify',
                 layout: 'topCenter',
                 type: 'warning',
             });*/
           ...
           /* noty({text: 'Warehouse in use.Please verify', layout: 'topRight', 
            	buttons: [
                          {
                          	addClass: 'btn btn-success btn-clean', text: 'Ok',type: 'error',onClick: function($noty) {
                                $noty.close();
                                
                            }
                          },
                          {addClass: 'btn btn-danger btn-clean', text: 'Cancel',type: 'error', onClick: function($noty) {
                              $noty.close();
